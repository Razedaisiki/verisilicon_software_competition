...
The script builds `src/Cargo.toml` offline with Rust 1.85, copies the rebuilt
candidate to `rebuilt/sr.exe`, and compares every byte with `bin/sr.exe`.
Conversation exports required for AI Coding review are under `logs/`.
""".encode("ascii")
